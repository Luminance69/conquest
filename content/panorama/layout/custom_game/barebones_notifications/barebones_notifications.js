...
function AddNotification(msg, panel) {
	...
	if (msg.hero != null) notification = $.CreatePanel("DOTAHeroImage", lastNotification, "");
	else if (msg.image != null) notification = $.CreatePanel("Image", lastNotification, "");
	else if (msg.ability != null) notification = $.CreatePanel("DOTAAbilityImage", lastNotification, "");
	else if (msg.item != null) notification = $.CreatePanel("DOTAItemImage", lastNotification, "");
