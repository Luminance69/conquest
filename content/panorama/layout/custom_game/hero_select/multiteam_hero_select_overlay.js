...
function UpdatePlayer(teamPanel, playerId) {
	...
	if (playerPanel === null) {
		...
		playerPanel.BLoadLayout(
			"file://{resources}/layout/custom_game/hero_select/multiteam_hero_select_overlay_player.xml",
			false,
			false,
		);
...
(function () {
	...
	for (var teamId of Game.GetAllTeamIDs()) {
		...
		teamPanel.BLoadLayout(
			"file://{resources}/layout/custom_game/hero_select/multiteam_hero_select_overlay_team.xml",
			false,
			false,
		);
